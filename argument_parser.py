...
def parse_args(params=None):
    ...
    # dataset
    parser.add_argument('--root-dir', type=str, default='/media/razvan/segcol/', help='root dir for dataset')
    parser.add_argument('--train-img-file', type=str, 
                        default='/media/razvan/segcol/train/train_list.csv', 
                        help='dir for train img dataset')
    parser.add_argument('--train-segm-file', type=str, 
                        default='/media/razvan/segcol/train/train_segmentation_maps.csv', 
                        help='dir for train annotation dataset')
    parser.add_argument('--valid-img-file', type=str, 
                        default='/media/razvan/segcol/valid/valid_list.csv', 
                        help='dir for validation img dataset')
    parser.add_argument('--valid-segm-file', type=str, 
                        default='/media/razvan/segcol/valid/valid_segmentation_maps.csv', 
